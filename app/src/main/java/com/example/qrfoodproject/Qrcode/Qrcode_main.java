...
public class Qrcode_main extends AppCompatActivity {
    ...
    private void doSetText(JSONObject jsonObject1) throws JSONException {
        ...
        protein.setText(String.format("%s毫克", jsonObject1.getString("protein")));
        fat.setText(String.format("%s毫克", jsonObject1.getString("fat")));
        saturateFat.setText(String.format("%s毫克", jsonObject1.getString("saturatedFat")));
        transFat.setText(String.format("%s毫克", jsonObject1.getString("transFat")));
        cholesterol.setText(String.format("%s毫克", jsonObject1.getString("cholesterol")));
        sugar.setText(String.format("%s毫克", jsonObject1.getString("sugar")));
        dietaryFiber.setText(String.format("%s毫克", jsonObject1.getString("dietaryFiber")));
